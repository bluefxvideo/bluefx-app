...
interface OptionsSectionProps {
  ...
  onChange: (options: Partial<OptionsSectionProps['options']>) => void;
}
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          {/* Aspect Ratio */}
          <div>
            <Label htmlFor="aspect-ratio" className="text-sm text-muted-foreground">Aspect Ratio</Label>
            <Select
      ...
      <Card className="p-3 bg-card">
        ...
        {options.generate_titles && (
          <div>
            <Label htmlFor="title-style" className="text-sm text-muted-foreground">Style</Label>
            <Select
        ...
        <Card className="p-3 space-y-3 bg-card border-dashed">
          ...
          <div>
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm text-muted-foreground">{options.guidance_scale || 3}</span>
            </div>
            <Input
              type="range"
              min="1"
          ...
          <div>
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm text-muted-foreground">{options.num_inference_steps || 28}</span>
            </div>
            <Input
              type="range"
              min="10"
          ...
          <div>
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm text-muted-foreground">{options.output_quality || 85}%</span>
            </div>
            <Input
              type="range"
              min="60"
