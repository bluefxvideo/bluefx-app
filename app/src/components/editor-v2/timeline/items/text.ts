...
class AIText extends Resizable {
	static type = "Text";
	declare id: string;
	declare text: string;
	...
	public drawTextIdentity(ctx: CanvasRenderingContext2D) {
		...
		// Don't clip - this might be hiding the text
		...
		const displayText = this.text || 'Text';
		...
		// Draw the "Aa" text icon on the left
		ctx.translate(8, textY - 6);
