 ...
 */
const FAL_IMAGE_SAFE_BYTES = 5_000_000;
async function ensureFalCompatibleImage(imageUrl: string | undefined, batchId: string, label: string): Promise<string | undefined> {
