  ...
  if (aiAssets.segments) {
    ...
    const captionTrack: ITrackItem = {
      ...
      details: {
        ...
        activeColor: "#00FF88",     // Active word color (green)  
        appearedColor: "#FFFFFF",   // Completed words color (white)
        activeFillColor: "#FF6B35", // Active word background (optional)
        ...
        // Store caption data in details for compatibility with captions.tsx
